...
public class ImageManager {
    ...
    public static BufferedImage BG2_IMAGE;
    public static BufferedImage BG3_IMAGE;
    static {
        try {
            BG2_IMAGE = ImageIO.read(new File("src/images/bg2.jpg"));
            BG3_IMAGE = ImageIO.read(new File("src/images/bg3.jpg"));
            ...
            CLASSNAME_IMAGE_MAP.put(ElitEnemy.class.getName(), Elite_ENEMY_IMAGE);
